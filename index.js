...
// change uri after clone with env and uri code from prev server code
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.jg1bs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
